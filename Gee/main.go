...
func main() {
	...
	v2 := r.Group("/v2")
	{
		v2.GET("/test", func(c *gee.Context) {
			c.String(http.StatusOK,"This is a test")
		})
		v2.GET("/:num", func(c *gee.Context) {
			c.String(http.StatusOK,"Number is %s", c.GetParam("num"))
		})
		v2.GET("/number", func(c *gee.Context) {
			c.String(http.StatusOK, "This is a default number!")
		})
